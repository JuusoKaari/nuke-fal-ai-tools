...
| Category | Tools |
|----------|--------|
| **Image** | Bria Extract Object, GPT Image 2, Hunyuan World, Nano Banana 2, **Qwen** (Inpaint, Layered, Max Edit), Seedream 5.0 Pro Edit, **Utility** (BiRefNet still, Depth, Finegrain, Topaz Precision) |
