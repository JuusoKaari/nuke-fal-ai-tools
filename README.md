...
| **Video** | DreamActor v2, **FLUX 3** (First/Last, Keyframes), Kling O3, **LTX** (2.3, 2.5 Pro), Pika v2.2, **Seedance** (2 I2V, 2 Reference, 2.5), Veo 3.1, **Utility** (BiRefNet, ByteDance upscale) |
| **3D** | Hunyuan 3D |
